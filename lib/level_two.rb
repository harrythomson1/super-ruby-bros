class LevelTwo
    ...
    def initialize
      @platforms = [ Rectangle.new(x: 150, y: Window.height - 85, color: 'orange', height: 10, z:6 , width: 77),
        ...
        Rectangle.new(x: 0, y: Window.height - 550, color: 'purple', height: 10, z:0 , width: 77),
        ...
        Rectangle.new(x: 150, y: Window.height - 450, color: 'purple', height: 10, z:6 , width: 40),
        Rectangle.new(x: 650, y: Window.height - 100, color: 'green', height: 10, z:6 , width:40)]
        
      @images = [Image.new('./assets/wood.png', z: 4, x: 0, y: Window.height - 550),
      ...
      @goal = Triangle.new(x1: 40, x2: 10, x3: 70, y1: Window.height - 600, y2: Window.height - 550, y3: Window.height - 550, color: 'fuchsia', z: 6)
